...
export const getAll = () => request.get(`${api.PRODUCTS}?sortBy=_createdAt%20desc`);

export const getOne = (id) => request.get(`${api.PRODUCTS}/${id}`);

export const getMy = (ownerId) => request.get(`${api.PRODUCTS}?where=_ownerId%3D%22${ownerId}%22&sortBy=_createdAt%20desc`);
